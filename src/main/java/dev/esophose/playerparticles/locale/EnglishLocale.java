...
public class EnglishLocale implements Locale {
    ...
    public Map<String, String> getDefaultLocaleStrings() {
        return new LinkedHashMap<String, String>() {{
            ...
            this.put("command-error-unknown", "&cUnknown command, use &b/pe help &cfor a list of commands.");
            ...
            this.put("command-descriptions-help-other", "&7> &b/peo <player> <command> &e- Run a /pe command as a player");
            ...
            this.put("command-description-fixed-create", "&e/pe fixed create <<x> <y> <z>|<looking>> <effect> <style> [data] - Creates a new fixed effect");
            this.put("command-description-fixed-create-console", "&e/pe fixed create <x> <y> <z> <world> <effect> <style> [data] - Creates a new fixed effect");
            this.put("command-description-fixed-edit", "&e/pe fixed edit <id> <effect|style|data|location> <args> - Edit part of a fixed effect by its ID");
            this.put("command-description-fixed-remove", "&e/pe fixed remove <ID> - Removes a fixed effect by its ID");
            this.put("command-description-fixed-list", "&e/pe fixed list - Lists all IDs of your fixed effects");
            this.put("command-description-fixed-info", "&e/pe fixed info <ID> - Gets info on one of your fixed effects");
            this.put("command-description-fixed-clear", "&e/pe fixed clear <radius> - Clears all fixed effects of all players within the given radius");
            this.put("command-description-fixed-clear-console", "&e/pe fixed clear <radius> <x> <y> <z> <world> - Clears all fixed effects of all players within the given radius");
            this.put("command-description-fixed-teleport", "&e/pe fixed teleport <id> - Teleports you to one of your fixed effects");

            this.put("#2.5", "Group Command Description Messages");
            this.put("command-description-group-save", "&e/pe group save <name> - Saves all active particles in a new group");
            this.put("command-description-group-load", "&e/pe group load <name> - Loads all particles saved in a group");
            this.put("command-description-group-remove", "&e/pe group remove <name> - Removes a group you have saved");
            this.put("command-description-group-list", "&e/pe group list <name> - List all particle groups you have saved");
            this.put("command-description-group-info", "&e/pe group info <name> - List the particles saved in the group");
            ...
            this.put("other-missing-args", "&cYou are missing some arguments. &b/peo <player> <command>");
            this.put("other-unknown-player", "&cThe player &b%player% &cwas not found. They must be online.");
            this.put("other-unknown-command", "&cThe command &b/pe %cmd% &cdoes not exist.");
            this.put("other-success", "&eExecuted /pe command for &b%player%&e. Output:");
            ...
            this.put("data-no-args", "&cMissing argument for effect! Command usage: &b/pe data <effect>");
            ...
            this.put("group-no-name", "&cYou did not provide a group name! &b/pe %cmd% <groupName>");
            ...
            this.put("remove-no-args", "&cYou did not specify an ID to remove! &b/pe remove <ID>");
            ...
            this.put("effect-invalid", "&cThe effect &b%effect% &cdoes not exist! Use &b/pe effects &cfor a list of effects you can use.");
            ...
            this.put("style-invalid", "&cThe style &b%style% &cdoes not exist! Use &b/pe styles &cfor a list of styles you can use.");
            ...
            this.put("fixed-create-data-error", "&cUnable to create fixed effect, the data provided is not correct! Use &b/pe data <effect> &cto find the correct data format!");
            ...
            this.put("fixed-edit-data-error", "&cUnable to edit fixed effect, the data provided is not correct! Use &b/pe data <effect> &cto find the correct data format!");
            ...
            this.put("fixed-invalid-command", "&cInvalid sub-command for &b/pe fixed&c!");
            ...
            this.put("gui-commands-info", "Find info about commands with &b/pe help");
            ...
            this.put("gui-save-group-chat-message", "&eUse &b/pe group save <name> &eto save a new particle group.");
